...
from services.admin_services import add_admin, list_books, add_new_book, remove_book, edit_books_titles, edit_books_quantities, add_book_author, remove_author, edit_books_authors, edit_worker_name, edit_worker_email, edit_worker_password, add_publisher, edit_publishers, remove_publisher, add_new_category, remove_category, edit_category, book_rent, book_return
from utils.utils import list_books, list_all_book_authors, list_book_publisher, list_book_category, list_all_reserved_books, list_rented_books
...
def crud_admin_rentings(user):
    while True:
        try: 
            ...
            print("2 - Listar os livros locados")
            print("3 - Efetuar a locação de um livro para um aluno")
            print("4 - Efetuar a devolução de um livro locado")
            print("5 - Voltar ao menu anterior")
            opc = int(input("Selecione a opção: "))
            match opc:
                case 1:
                    system('cls')
                    list_all_reserved_books()
                case 2:
                    system('cls')
                    list_rented_books()
                case 3:
